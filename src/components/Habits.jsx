  ...
  return (
   <div className="bg-[#001118] text-white">
     <div className=" container mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2  gap-4 px-2 lg:grid-cols-4 lg:space-y-0 md:space-x-0 space-y-8 text-center">
        <div className="text-center max-w-lg border border-[#FFFFFF20] rounded-lg p-2 hover:border-b-[#E6533C] hover:border-r-[#E6533C] hover:border-b-4 border-r-4 border-b-4 hover:border-r-4 cursor-pointer  px-4 hover:scale-105 transition-all duration-300 ease-in-out">
